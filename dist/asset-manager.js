...
(function (Scratch) {
  ...
  function splitSourceAndAssetName(payload, scheme) {
  ...
  class AssetManagerExtension {
    ...
    registerBackgroundReference(name, backgroundName) {
      const stage = this.getStageTarget();
