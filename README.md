...
```bash
pnpm add --save-exact @kubohiroya/turbowarp-asset-manager@0.14.0
```

Load `node_modules/@kubohiroya/turbowarp-asset-manager/dist/asset-manager.js`, or use the version-pinned CDN URL:

```text
https://cdn.jsdelivr.net/npm/@kubohiroya/turbowarp-asset-manager@0.14.0/dist/asset-manager.js
```
