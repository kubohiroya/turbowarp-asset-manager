...
```bash
pnpm add --save-exact @kubohiroya/turbowarp-asset-manager@0.10.0
```
...
```text
https://cdn.jsdelivr.net/npm/@kubohiroya/turbowarp-asset-manager@0.10.0/dist/asset-manager.js
```
